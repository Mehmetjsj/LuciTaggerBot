...
async def start(event):
  await event.reply("**TaggerBot**\n ile Grubunuzdakı Nerdeyse Tüm Üyelere Etiket Ata bilirim \nKomutlar için =======> /help yazın**",
		      ...
		      [Button.url('Beni Gruba Ekle ➕', 'https://t.me/etkytghbot?startgroup=a')],
                      [Button.url('Support🛠', 'https://t.me/gycyolcu')],
                      [Button.url('Resmi Kanal📣', 'https://t.me/umutyolculuk')],
...
async def help(event):
  ...
  await event.reply(helptext,
                    buttons=(
                      [Button.url('Botu Gruba Ekle➕', 'https://t.me/etkytghbot?startgroup=a')],
                    ),
                    link_preview=False
                   )
...
print(">> Bot çalıyor merak etme 🚀 @evetbenim38 bilgi alabilirsin <<")
